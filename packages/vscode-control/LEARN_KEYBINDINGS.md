...
| CTRL+SHIFT+G | interactiveEditor.generate          | CTRL+M        | match                               |
...
| CTRL+SHIFT+X | Xplain                              | CTRL+SHIFT+3  | Snippet - TestCase                  |
| CTRL+5       | github.copilot.chat.explain         | CTRL+SHIFT+4  | Snippet - Expect                    |
| CTRL+6       | inlineChat.start                    | ALT+D         | Snippet - debugger                  |
...
| CTRL+4       | action.toggleMaximizedPanel         | CTRL+9        | Snippet - comment as title          |
...
| ALT+A        | this needs to be convenient         | CTRL+G        | action.goToTypeDefinition           |
...
| CTRL+`       | action.selectHighlights             | CTRL+SHIFT+L  | lines                               |
| CTRL+D       | goToSourceDefinition                | CTRL+SHIFT+T  | test                                |
...
| CTRL+SHIFT+Z | action.toggleZenMode                | CTRL+SHIFT+;  | needed after running vscode control |
| CTRL+SHIFT+, | output.toggleOutput                 | CTRL+SHIFT+'  | extension.markdown-pdf.pdf          |
| CTRL+SHIFT+R | debug.restart                       |               |                                     |