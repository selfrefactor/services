...
| CTRL+SHIFT+X | interactiveEditor.fix               | CTRL+SHIFT+3  | Snippet - TestCase             |
...
| CTRL+E       | findReferences                      | CTRL+O        | files.openFolder               |
| CTRL+`       | action.selectHighlights             | ALT+E         | workbench.view.explorer        |
| CTRL+D       | goToSourceDefinition                | CTRL+SHIFT+L  | magicBeans.sortLines           |
| CTRL+SHIFT+K | workbench.action.selectTheme        | CTRL+SHIFT+T  | magicBeans.createSpec          |
| CTRL+SHIFT+` | showActiveFileInExplorer            | ALT+C         | magicBeans.copyTrimmed         |
