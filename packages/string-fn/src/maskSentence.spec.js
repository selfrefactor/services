...
test('easy mode, no random', () => {
	...
	const expectedHidden = ['Unnecessary', 'complexity', 'killed', 'the', 'cat', '.'];
	const expectedVisible = ['Un______ary', 'co_____ity', 'k___ed', 't__', 'c__', '.'];
	const { hidden, visible } = maskSentence({
		sentence,
		easyMode: true,
	});
...
test('easy mode, low char limit', () => {
	...
	const expectedHidden = ['Unnecessary', 'complexity', 'killed', 'th', 'cat', '.'];
	const expectedVisible = ['Un______ary', 'co_____ity', 'k___ed', 'th', 'c_t', '.'];
	const { hidden, visible } = maskSentence({
		sentence,
		easyMode: true,
		charLimit: 1,
