...
test('0', () => {
	expect(between('2,626/две цяло и шестстотин двадесет и шест/', '/')).toEqual(
		'две цяло и шестстотин двадесет и шест',
	);
});
...
test('3', () => {
	expect(between('begin foo bar baz end', 'q', 'x')).toEqual(
